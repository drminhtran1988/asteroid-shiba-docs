...
<img src="../.gitbook/assets/scanner-lv0.png" alt="Scanner Level 0" width="200">
...
* **Storage for up to 49 more** finds, held for you until you upgrade. See [Asteroid storage](storage.md).
* **Research** on your active asteroid, to raise what it earns.
* **Withdrawals**, up to a lifetime total of $25. See [The Level 0 withdrawal limit](limits.md).
...
The **first Common you find** goes into the slot and starts mining ASTRO for you every day. Every find after that — including another Common — goes to [storage](storage.md). Commons always pay their 1,000 ASTRO instant reward, whether they land in the slot or in storage.
...
**Next:** [Asteroid storage →](storage.md)
